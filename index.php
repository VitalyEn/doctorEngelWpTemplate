        ...
        <div>
            ...
            <ul class="featured-post__list">
                <li class="featured-post__container">
                    <img class="featured-post__image" src="<?php echo bloginfo('template_url'); ?>/assets/images/dest/fposts 1.png" alt="post 1">
                ...
                <li class="featured-post__container">
                    <img class="featured-post__image" src="<?php echo bloginfo('template_url'); ?>/assets/images/dest/fposts 2.png" alt="post 2">
        ...
        <div>
            ...
            <ul class="most-recent__list">
                <li class="most-recent__container">
                    <img class="most-recent__image" src="<?php echo bloginfo('template_url'); ?>/assets/images/dest/mr 1.png" alt="post 1">
                ...
                <li class="most-recent__container">
                    <img class="most-recent__image" src="<?php echo bloginfo('template_url'); ?>/assets/images/dest/mr 2.png" alt="post 2">
                    <div class="most-recent__slogancontainer">
                ...
                <li class="most-recent__container ">
                    <img class="most-recent__image " src="<?php echo bloginfo('template_url'); ?>/assets/images/dest/mr 3.png " alt="post 3">
                    <div class="most-recent__slogancontainer ">
                ...
                <li class="most-recent__container ">
                    <img class="most-recent__image " src="<?php echo bloginfo('template_url'); ?>/assets/images/dest/mr 4.png " alt="post 4">
                    <div class="most-recent__slogancontainer ">
                ...
                <li class="most-recent__container ">
                    <img class="most-recent__image " src="<?php echo bloginfo('template_url'); ?>/assets/images/dest/mr 5.png " alt="post 5">
                    <div class="most-recent__slogancontainer ">
                ...
                <li class="most-recent__container ">
                    <img class="most-recent__image " src="<?php echo bloginfo('template_url'); ?>/assets/images/dest/mr 6.png " alt="post 6 ">
                    <div class="most-recent__slogancontainer ">
